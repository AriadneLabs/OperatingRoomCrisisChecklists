<script>
    ...
    import { model } from "../models/tachycardia.js";
    ...
    let synchronizedCardioversion =
        model.references["synchronized-cardioversion"];
    let energyLevel = model.references["energy-level"];
    ...
    $: currentEnergyTopAlign = energyTop;
    $: currentCCTopAlign = ccTop;
    ...
    function editChecklist() {
        ...
        if (editButtonLabel === "Edit") {
            ...
            energyTop = (offsetH / 96 + 1).toString() + "in"; // "2.6in";
            ccTop = (offsetH / 96 + 2.65).toString() + "in";
        } else {
            energyTop = "3.45in";
            ccTop = "5.05in";
        }
    ...
    <div id="page-body">
        ...
        <div id="page-body-content">
            ...
            <ReferenceSection
                ...
                referenceHeight="-0.4in"
                referenceWidth="4in"
            />
            <ReferenceSection
                referenceRightAlign="0"
                referenceName={synchronizedCardioversion}
                referenceColor="gray"
                referenceHeight="0.9in"
                referenceWidth="4in"
                {canEdit}
            />
            <ReferenceSection
                referenceRightAlign="0"
                referenceName={energyLevel}
                referenceColor="#6aa84f"
                referenceHeight={currentEnergyTopAlign}
                referenceWidth="4in"
            />
            <ReferenceSection
                referenceRightAlign="0"
                ...
                referenceHeight={currentCCTopAlign}
                referenceWidth="4in"
            />
        </div>
        <footer>
...
<style>
    ...
    ul.step-actions-list {
        list-style-image: url("images/action-list-style.png");
    }
</style>
