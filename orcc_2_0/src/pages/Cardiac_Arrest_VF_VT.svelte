<script>
  ...
  import { model } from "../models/cardiac_arrest_vf_vt.js";
  ...
  let defibrillatorInstructions =
    model.references["defibrillator-instructions"];
  let roleAssignments = model.references["role-assignments"];
  ...
  <div id="page-body">
    ...
    <div id="page-body-content">
                                              ...
                                              {#each subSubStep.subList as subSubSubStep, i_subsubsubstep}
                                                <li>
                                                  ...
                                                  {:else if typeof subSubSubStep !== "string" || subSubSubStep instanceof Object}
                                                    ...
                                                    <ul>
                                                      {#each subSubSubStep.subList as fourthSubStep, i_fourthsubstep}
                                                        <li>
                                                          {@html fourthSubStep}
                                                        </li>
                                                      {/each}
      ...
      <ReferenceSection referenceRightAlign="0"
        ...
        referenceHeight="-0.5in"
        referenceWidth="4in"
        {canEdit}
      />

      <ReferenceSection referenceRightAlign="0"
        referenceName={defibrillatorInstructions}
        referenceColor="gray"
        referenceHeight="1.5in"
        referenceWidth="4in"
        {canEdit}
      />

      <ReferenceSection referenceRightAlign="0"
        referenceName={roleAssignments}
