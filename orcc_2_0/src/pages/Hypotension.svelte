<script>
  ...
  import { model } from "../models/hypotension.js";
  ...
  <div id="page-body">
    ...
    <div id="page-body-content">
            ...
            <li class="step-container">
              ...
              <div class="step-item" id="page-step-{step.id}">
                <div class="step-item-content">
                  ...
                  {#if step.subContent}
                    <div class="step-item-sub-content">
                      {#if step.subContent.contentType === "bullet-list"}
                          ...
                          {#each step.subContent.items as subStep, i_substep}
                            ...
                            {:else if typeof subStep !== "string" || subStep instanceof Object}
                              <div>
                                ...
                                {#if subStep.beforeContent}
                                  <div class="substep-before-content">
                                    {@html subStep.beforeContent}
                                  </div>
                                  {#each subStep.list as subSubStep, i_subsubstep}
                                    <li>
                                      <div>
                                        {@html subSubStep}
                                      </div>
                                ...
                                {:else}
                                  <li>
                                    ...
                                    {#if subStep.info && canEdit}
                                      ...
                                      {#if showInfoPopup && currentPopupText === subStep.info}
                                        <div class="infotext-container">
                                          <div class="infotext-content">
                                            <div style="font-weight: bold">
                                              {@html subStep.text}
      ...
      <ReferenceSection referenceRightAlign="0"
        ...
        {canEdit}
      />
      <ReferenceSection referenceRightAlign="3.4in"
        referenceName={differentialDiagnosis}
        referenceColor="var(--purple)"
        referenceHeight="1.4in"
        referenceWidth="3in"
      />
    </div>
    <footer>
...
<style>
  ...
  #page-body-content > #differential-diagnosis {
    right: 3.4in !important;
  }
