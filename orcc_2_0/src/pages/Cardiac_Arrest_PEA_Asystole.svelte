<script>
  ...
  import { model } from "../models/cardiac_arrest_pea_asystole.js"; // diff: change model
  ...
  let roleAssignment = model.references["role-assignment"];
  let editOk = false;
...
<div id="editor-page" ng-controller="MainCtrl">
  <div id="page-header">
    <div id="page-header-main-row">
      ...
      <img
        class="pea-asystole-image"
        src="../../build/images/pea_asystole.png"
        alt="PEA/Asystole images"
      />
    </div>
