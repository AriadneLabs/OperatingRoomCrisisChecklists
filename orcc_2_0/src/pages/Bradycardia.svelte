<script>
  ...
  import { model } from "../models/bradycardia.js";
  ...
  let trancutaneousPacing =
    model.references["trancutaneous-pacing-instructions"];
  ...
  <div id="page-body">
    ...
    <div id="page-body-content">
      ...
      <ReferenceSection referenceRightAlign="0"
        ...
        {canEdit}
        referenceWidth="4.5in"
      />

      <ReferenceSection referenceRightAlign="0"
        referenceName={differentialDiagnosis}
        referenceColor="var(--purple)"
        referenceHeight="2.3in"
        referenceWidth="4.5in"
      />

      <ReferenceSection referenceRightAlign="0"
        referenceName={trancutaneousPacing}
        referenceColor="gray"
        referenceHeight="3.8in"
        referenceWidth="5.5in"
        {canEdit}
      />
    </div>
    <footer>
