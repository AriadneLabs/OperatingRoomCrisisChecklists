<script>
  ...
  import { model } from "../models/hypoxia.js";
  ...
  let additionalDiagnostics = model.references["additional-diagnostics"];
                            ...
                            <li>
                              ...
                              {:else if typeof subStep !== "string" || subStep instanceof Object}
                                <div>
                                  ...
                                  <!-- begin branch -->
                                  {#if subStep.branches}
                                    {#each subStep.branches as branch}
                                      <div class="branch-container">
                                        <div class="branch-header">
                                          {@html branch.header}
                                        </div>
                                        {#each branch.sections as subBranch}
                                          <div class="subbranch-container">
                                            <div class="subbranch-header">
                                              {subBranch.header}
                                            </div>
                                            <ul>
                                              {#each subBranch.subList as subBranchStep}
                                                <li class="subbranch-body">
                                                  {@html subBranchStep}
                                                </li>
                                              {/each}
                                            </ul>
